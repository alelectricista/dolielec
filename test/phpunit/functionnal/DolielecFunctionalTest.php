...
/**
 * \file    test/phpunit/DolielecFunctionalTest.php
 * \ingroup dolielec
 ...
 *
 * @package Testdolielec
 */
class DolielecFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 104000; // TODO: autodetect?
	...
	{
		$this->url('/custom/dolielec/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolielec/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolielec/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolielec/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolielecwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDolielec_DolielecTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDolielec_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
