...
class OpenAI {
	...
	public function setPrompt($system = '', $user = '', $tools = null, $api_key = '') {
		$model = getDolGlobalString('OPENAI_DEFAULT_MODEL');
		$data = array('model' => $model, 'messages' => array(array('role' => 'system', 'content' => $system), array('role' => 'user', 'content' => $user)));
